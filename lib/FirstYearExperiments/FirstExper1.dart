...
class FirExp1 extends StatefulWidget {
  @override
  _FirExp1State createState() => _FirExp1State();
}

class _FirExp1State extends State<FirExp1> {
  @override
                  ...
                  Center(
                    child: CachedNetworkImage(
                      imageUrl:
                          ...
                          'https://live.staticflickr.com/65535/49665916181_43bd7d036c_c.jpg',
                      errorWidget: (context, url, error) => Icon(Icons.error),
                    ),
                  ),
                  Center(
                    child: CachedNetworkImage(
                      imageUrl:
                          'https://live.staticflickr.com/65535/49665372313_bfa69e04d8_c.jpg',
                      errorWidget: (context, url, error) => Icon(Icons.error),
                    ),
                  ),
                  Center(

...
class ThExp13 extends StatefulWidget {
  @override
  _ThExp13State createState() => _ThExp13State();
}

class _ThExp13State extends State<ThExp13> {
  @override
              ...
              new SliverList(
                delegate: SliverChildListDelegate([
                  ...
                  Center(
                    child: CachedNetworkImage(
                      imageUrl:
                          ...
                          'https://live.staticflickr.com/65535/49719172736_3274f3cb72_b.jpg',
                      errorWidget: (context, url, error) => Icon(Icons.error),
                  ...
                  Center(
                    child: CachedNetworkImage(
                      imageUrl:
                          'https://live.staticflickr.com/65535/49719171656_bdd922ce38_b.jpg',
                      errorWidget: (context, url, error) => Icon(Icons.error),
                      placeholder: (context, url) =>
                          CircularProgressIndicator(),
                    ),
                  ...
                  //     imageUrl:
                  //         // 'https://images.unsplash.com/photo-1542362567-b07e54358753?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=500&q=60',
                  //         'https://live.staticflickr.com/65535/49665371718_9f75d7eafb_c.jpg',
                  //     errorWidget: (context, url, error) => Icon(Icons.error),
                  //   ),
                  // ),
                ]),

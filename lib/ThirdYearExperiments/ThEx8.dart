...
class ThExp8 extends StatefulWidget {
  @override
  _ThExp8State createState() => _ThExp8State();
}

class _ThExp8State extends State<ThExp8> {
  @override
              ...
              new SliverList(
                delegate: SliverChildListDelegate([
                  ...
                  Center(
                    child: CachedNetworkImage(
                      imageUrl:
                          ...
                          'https://live.staticflickr.com/65535/49719180871_b2eb397d5d_b.jpg',
                      errorWidget: (context, url, error) => Icon(Icons.error),
                  ...
                  Center(
                    child: CachedNetworkImage(
                      imageUrl:
                          'https://live.staticflickr.com/65535/49718639578_b7a134ffdf_b.jpg',
                      errorWidget: (context, url, error) => Icon(Icons.error),
                      placeholder: (context, url) =>
                          CircularProgressIndicator(),
                    ),
                  ...
                  Center(
                    child: CachedNetworkImage(
                      imageUrl:
                          // 'https://images.unsplash.com/photo-1542362567-b07e54358753?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=500&q=60',
                          'https://live.staticflickr.com/65535/49718638673_bf9305fe5d_b.jpg',
                      errorWidget: (context, url, error) => Icon(Icons.error),
                      placeholder: (context, url) =>
                          CircularProgressIndicator(),
                    ),

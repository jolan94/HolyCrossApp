...
class ThExp7 extends StatefulWidget {
  @override
  _ThExp7State createState() => _ThExp7State();
}

class _ThExp7State extends State<ThExp7> {
  @override
              ...
              new SliverList(
                delegate: SliverChildListDelegate([
                  ...
                  Center(
                    child: CachedNetworkImage(
                      imageUrl:
                          ...
                          'https://live.staticflickr.com/65535/49719495632_756b8829c1_b.jpg',
                      errorWidget: (context, url, error) => Icon(Icons.error),
                  ...
                  Center(
                    child: CachedNetworkImage(
                      imageUrl:
                          'https://live.staticflickr.com/65535/49718641103_806ae7609a_b.jpg',
                      errorWidget: (context, url, error) => Icon(Icons.error),
                      placeholder: (context, url) =>
                          CircularProgressIndicator(),
                    ),
                  ...
                  Center(
                    child: CachedNetworkImage(
                      imageUrl:
                          // 'https://images.unsplash.com/photo-1542362567-b07e54358753?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=500&q=60',
                          'https://live.staticflickr.com/65535/49719178661_9a171612d3_b.jpg',
                      errorWidget: (context, url, error) => Icon(Icons.error),
                      placeholder: (context, url) =>
                          CircularProgressIndicator(),
                    ),

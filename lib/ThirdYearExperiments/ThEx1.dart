...
class ThExp1 extends StatefulWidget {
  @override
  _ThExp1State createState() => _ThExp1State();
}

class _ThExp1State extends State<ThExp1> {
  @override
              ...
              new SliverList(
                delegate: SliverChildListDelegate([
                  ...
                  Center(
                    child: CachedNetworkImage(
                      imageUrl:
                          ...
                          'https://live.staticflickr.com/65535/49718660973_9572b9bf83_b.jpg',
                      errorWidget: (context, url, error) => Icon(Icons.error),
                  ...
                  Center(
                    child: CachedNetworkImage(
                      imageUrl:
                          'https://live.staticflickr.com/65535/49719513452_62f079c04c_b.jpg',
                      errorWidget: (context, url, error) => Icon(Icons.error),
                      placeholder: (context, url) =>
                          CircularProgressIndicator(),
                    ),
